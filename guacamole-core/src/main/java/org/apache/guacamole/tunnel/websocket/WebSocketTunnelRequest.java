...
public class WebSocketTunnelRequest extends TunnelRequest {
    ...
    /**
     * Creates a TunnelRequest implementation which uses the given parameter map directly.
     *
     * @param parameters The parameter map to use.
     */
    public WebSocketTunnelRequest(Map<String, List<String>> parameters) {
        this.handshakeParameters = parameters;
    }
