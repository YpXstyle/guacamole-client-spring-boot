 ...
 * </ol>
 *
 * This logic is independent of directory layout conventions ({@code starters/},
 * {@code guacamole-core}, …) — it only relies on class-output-directory markers
 * that are identical across Maven, Gradle and IDE builds.
 */
@Configuration
public class LanguageConfig {
     ...
     * container directories ("starters", "modules", …) from being added to the
     * allow-list and accidentally matching every module beneath them.
     *
     * <pre>
     *   .../group/my-starter          →  .../group      (group = "guacamole-auth-jdbc")
     *   .../starters/my-starter       →  null           (parent = "starters", not a module group)
