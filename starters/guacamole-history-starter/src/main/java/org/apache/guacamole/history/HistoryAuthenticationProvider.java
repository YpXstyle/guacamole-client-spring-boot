...
public class HistoryAuthenticationProvider extends AbstractAuthenticationProvider {
    ...
    /**
     * Recording search path set by Spring Boot auto-configuration.
     * When non-null, this takes precedence over LocalEnvironment.
     */
    private static volatile File springRecordingSearchPath;

    /**
     * Sets the recording search path from Spring Boot configuration.
     * Called by HistoryAutoConfiguration.
     *
     * @param path
     *     The recording search path from application.yml
     */
    public static void setSpringRecordingSearchPath(File path) {
        springRecordingSearchPath = path;
    }
    ...
    public static File getRecordingSearchPath() throws GuacamoleException {
        // Spring Boot configuration takes precedence
        if (springRecordingSearchPath != null)
            return springRecordingSearchPath;
        // Fall back to LocalEnvironment (guacamole.properties)
