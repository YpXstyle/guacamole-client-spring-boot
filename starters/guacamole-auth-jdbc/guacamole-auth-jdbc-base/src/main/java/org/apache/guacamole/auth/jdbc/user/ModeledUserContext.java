...
public class ModeledUserContext extends RestrictedObject
     ...
     */
    @Autowired
    private ObjectProvider<RootConnectionGroup> rootGroupProvider;

    /**
     * Provider for creating connection record sets.
     */
    @Autowired
    private ObjectProvider<ConnectionRecordSet> connectionRecordSetProvider;

    /**
     * Provider for creating user record sets.
     */
    @Autowired
    private ObjectProvider<UserRecordSet> userRecordSetProvider;

    /**
     * Provider for retrieving UserContext instances.
     */
    @Autowired
    private ObjectProvider<ModeledUserContext> userContextProvider;
    ...
    public UserContext getPrivileged() {
        ModeledUserContext context = userContextProvider.getObject();
    ...
    public ConnectionRecordSet getConnectionHistory()
            throws GuacamoleException {
        ConnectionRecordSet connectionRecordSet = connectionRecordSetProvider.getObject();
    ...
    public ActivityRecordSet<ActivityRecord> getUserHistory()
            throws GuacamoleException {
        UserRecordSet userRecordSet = userRecordSetProvider.getObject();
    ...
    public ConnectionGroup getRootConnectionGroup() throws GuacamoleException {
        ...
        RootConnectionGroup rootGroup = rootGroupProvider.getObject();
