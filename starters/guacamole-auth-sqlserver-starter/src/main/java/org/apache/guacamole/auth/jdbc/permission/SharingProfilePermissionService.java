...
public class SharingProfilePermissionService extends ModeledObjectPermissionService {
     ...
     */
    @Autowired
    private ObjectProvider<SharingProfilePermissionSet> sharingProfilePermissionSetProvider;
    ...
    public ObjectPermissionSet getPermissionSet(ModeledAuthenticatedUser user,
        ...
        ObjectPermissionSet permissionSet = sharingProfilePermissionSetProvider.getObject();
