...
public class KsmClient {
     ...
     */
    private final KsmConfigurationService confService;

    /**
     * Service for retrieving data from records.
     */
    private final KsmRecordService recordService;

    /**
     * Creates a new KsmClient with the specified configuration and record services.
     *
     * @param confService
     *     The configuration service to use for retrieving KSM configuration.
     *
     * @param recordService
     *     The record service to use for parsing record data.
     */
    public KsmClient(KsmConfigurationService confService, KsmRecordService recordService) {
