...
public class KsmSecretService implements VaultSecretService {
    ...
    /**
     * Creates a new KsmSecretService with the specified client and record service.
     *
     * @param ksm
     *     The KSM client to use for retrieving secrets.
     *
     * @param recordService
     *     The record service to use for parsing record data.
     */
    public KsmSecretService(KsmClient ksm, KsmRecordService recordService) {
        this.ksm = ksm;
