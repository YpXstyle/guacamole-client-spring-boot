...
public class AssertionConsumerServiceResource extends SSOResource {
    ...
    public ResponseEntity<Object> processSamlResponse(
        ...
        try {
            ...
            URI redirectUri = UriComponentsBuilder.fromUri(guacBase)
        ...
        // If invalid, redirect back to main page to re-attempt authentication
            ...
            return ResponseEntity.status(HttpStatus.FOUND).location(guacBase).build();
        }
