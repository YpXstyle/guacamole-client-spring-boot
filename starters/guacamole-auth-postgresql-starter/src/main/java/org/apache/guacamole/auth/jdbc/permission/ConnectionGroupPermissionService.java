...
public class ConnectionGroupPermissionService extends ModeledObjectPermissionService {
     ...
     */
    @Autowired
    private ObjectProvider<ConnectionGroupPermissionSet> connectionGroupPermissionSetProvider;
    ...
    public ObjectPermissionSet getPermissionSet(ModeledAuthenticatedUser user,
        ...
        ObjectPermissionSet permissionSet = connectionGroupPermissionSetProvider.getObject();
