...
public class ConnectionPermissionService extends ModeledObjectPermissionService {
     ...
     */
    @Autowired
    private ObjectProvider<ConnectionPermissionSet> connectionPermissionSetProvider;
    ...
    public ObjectPermissionSet getPermissionSet(ModeledAuthenticatedUser user,
        ...
        ObjectPermissionSet permissionSet = connectionPermissionSetProvider.getObject();
