...
public class AssertionConsumerServiceResource extends SSOResource {
    ...
    public Response processSamlResponse(
        ...
        try {
            ...
            URI redirectUri = new java.net.URI(guacBase.getScheme(),
                    guacBase.getAuthority(), guacBase.getPath(),
                    AuthenticationProviderService.AUTH_SESSION_QUERY_PARAM + "=" + identifier,
                    null);
        ...
        // If invalid, redirect back to main page to re-attempt authentication
            ...
            logger.error("Failed to construct redirect URI: {}", e.getMessage());
            return Response.seeOther(guacBase).build();
        }
