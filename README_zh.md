...
| 文档 | 中文 | English | 说明 |
|------|------|---------|------|
| 快速入门 | [QUICK-START.md](docs/QUICK-START.md) | [QUICK-START_EN.md](docs/QUICK-START_EN.md) | 环境检查、安装、首次登录（**新用户请从这里开始**） |
| 配置参考 | [CONFIGURATION.md](docs/CONFIGURATION.md) | [CONFIGURATION_EN.md](docs/CONFIGURATION_EN.md) | 所有扩展的完整配置参考 |
| 构建部署 | [BUILD.md](docs/BUILD.md) | [BUILD_EN.md](docs/BUILD_EN.md) | 构建、Docker 和部署指南 |
| 扩展开发 | [EXTENSIONS.md](docs/EXTENSIONS.md) | [EXTENSIONS_EN.md](docs/EXTENSIONS_EN.md) | 扩展系统架构和开发指南 |
| 系统架构 | [ARCHITECTURE.md](docs/ARCHITECTURE.md) | [ARCHITECTURE_EN.md](docs/ARCHITECTURE_EN.md) | 深入系统架构分析 |
| 迁移指南 | [MIGRATION.md](docs/MIGRATION.md) | [MIGRATION_EN.md](docs/MIGRATION_EN.md) | Guice 到 Spring Boot 迁移参考，含属性映射表 |
| REST API | [REST-API.md](docs/REST-API.md) | [REST-API_EN.md](docs/REST-API_EN.md) | REST API 端点参考 |
| Vault 模块 | [vault-module.md](docs/vault-module.md) | [vault-module_EN.md](docs/vault-module_EN.md) | Vault / KSM 模块详细文档 |
