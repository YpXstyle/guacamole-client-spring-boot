...
public class MySQLPasswordPolicy implements PasswordPolicy {
    ...
    private static final Logger logger = LoggerFactory.getLogger(MySQLPasswordPolicy.class);
     ...
     * from the properties exposed by the given environment, with optional
     * overrides from the database-backed system configuration.
     *
     * @param environment
