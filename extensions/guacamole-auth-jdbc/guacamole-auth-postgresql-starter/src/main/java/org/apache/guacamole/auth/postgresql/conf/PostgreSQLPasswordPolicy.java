...
public class PostgreSQLPasswordPolicy implements PasswordPolicy {
    ...
    private static final Logger logger = LoggerFactory.getLogger(PostgreSQLPasswordPolicy.class);
    ...
    /**
     * Returns the DB config value for the given key, or null if not available.
     */
