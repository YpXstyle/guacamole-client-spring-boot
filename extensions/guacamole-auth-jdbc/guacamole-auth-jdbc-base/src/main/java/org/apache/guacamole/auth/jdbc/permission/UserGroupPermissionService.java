...
public class UserGroupPermissionService extends ModeledObjectPermissionService {
     ...
     */
    @Autowired
    private ObjectProvider<UserGroupPermissionSet> userGroupPermissionSetProvider;
    ...
    public ObjectPermissionSet getPermissionSet(ModeledAuthenticatedUser user,
        ...
        ObjectPermissionSet permissionSet = userGroupPermissionSetProvider.getObject();
