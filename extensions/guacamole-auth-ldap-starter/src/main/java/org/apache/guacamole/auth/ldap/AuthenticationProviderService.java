...
public class AuthenticationProviderService {
     ...
     */
    @Autowired
    private ObjectProvider<LDAPAuthenticatedUser> authenticatedUserProvider;

    /**
     * Provider for UserContext objects.
     */
    @Autowired
    private ObjectProvider<LDAPUserContext> userContextProvider;
    ...
    public LDAPAuthenticatedUser authenticateUser(Credentials credentials)
        ...
        try {
            ...
            LDAPAuthenticatedUser authenticatedUser = authenticatedUserProvider.getObject();
    ...
    public LDAPUserContext getUserContext(AuthenticatedUser authenticatedUser)
        ...
        if (authenticatedUser instanceof LDAPAuthenticatedUser) {
            ...
            try {
                ...
                LDAPUserContext userContext = userContextProvider.getObject();
